...
// List of common cardamom hubs in India (can be expanded)
export const cardamomHubs = [
  "Kumily Hub (Thekkady, Kerala)",
  "Munnar Hub (Idukki, Kerala)",
  "Vandanmedu Hub (Idukki, Kerala)",
  "Bodinayakanur Hub (Theni, Tamil Nadu)",
  "Cumbum Hub (Theni, Tamil Nadu)",
  "Gudalur Hub (Nilgiris, Tamil Nadu)",
  "Kodaikanal Hub (Dindigul, Tamil Nadu)",
  "Yercaud Hub (Salem, Tamil Nadu)",
  "Coorg Hub (Kodagu, Karnataka)",
  "Chikmagalur Hub (Karnataka)",
  "Sakleshpur Hub (Hassan, Karnataka)",
  "Wayanad Hub (Kerala)",
  "Kalpetta Hub (Wayanad, Kerala)",
  "Sulthan Bathery Hub (Wayanad, Kerala)",
  "Kochi Spice Market (Ernakulam, Kerala)",
  "Cochin Port Hub (Ernakulam, Kerala)",
  "Chennai Spice Market (Tamil Nadu)",
  "Bangalore Spice Market (Karnataka)",
  "Mumbai Spice Market (Maharashtra)",
  "Delhi Spice Market (Delhi)"
];

// Get districts for a specific state
export const getDistrictsForState = (state) => {
  return indianStatesDistricts[state] || [];
};

// Get all states
export const getAllStates = () => {
  return Object.keys(indianStatesDistricts).sort();
};

// Get all cardamom hubs
export const getAllCardamomHubs = () => {
  return cardamomHubs.sort();
};
